<template>
  ...
  >
    ...
    <slot :slot="'last_login'" slot-scope='record' name='last_login' :record='record'/>
    <slot :slot="'is_superuser'" slot-scope='record' name='is_superuser' :record='record'/>
    ...
    <slot :slot="'is_staff'" slot-scope='record' name='is_staff' :record='record'/>
    <slot :slot="'is_active'" slot-scope='record' name='is_active' :record='record'/>
    <slot :slot="'date_joined'" slot-scope='record' name='date_joined' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedAuth_user(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
