<template>
  ...
  >
    ...
    <slot :slot="'group_id'" slot-scope='record' name='group_id' :record='record'/>
...
export default {
  name: "auth_group_permissions_table",
  ...
  inject: {
    ...
    setSelectedAuth_group_permissions: {
      default: () => {
      }
    }
  },
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedAuth_group_permissions(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
