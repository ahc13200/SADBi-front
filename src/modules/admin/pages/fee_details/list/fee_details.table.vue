<template>
  ...
  >
    ...
    <slot :slot="'fee_type'" slot-scope='record' name='fee_type' :record='record'/>
    <slot :slot="'range_init'" slot-scope='record' name='range_init' :record='record'/>
    <slot :slot="'range_end'" slot-scope='record' name='range_end' :record='record'/>
    <slot :slot="'fee_value'" slot-scope='record' name='fee_value' :record='record'/>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedFee_details(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
