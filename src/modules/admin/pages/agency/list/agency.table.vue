<template>
  ...
  >
    ...
    <slot :slot="'language'" slot-scope='record' name='language' :record='record'/>
    <slot :slot="'low_funds_warning'" slot-scope='record' name='low_funds_warning' :record='record'/>
    <slot :slot="'sentai_code'" slot-scope='record' name='sentai_code' :record='record'/>
    <slot :slot="'funds_balance'" slot-scope='record' name='funds_balance' :record='record'/>
    <slot :slot="'funds_work'" slot-scope='record' name='funds_work' :record='record'/>
    <slot :slot="'state'" slot-scope='record' name='state' :record='record'/>
    <slot :slot="'accept_reject'" slot-scope='record' name='accept_reject' :record='record'/>
    <slot :slot="'self_sending'" slot-scope='record' name='self_sending' :record='record'/>
    <slot :slot="'fee_percent'" slot-scope='record' name='fee_percent' :record='record'/>
    <slot :slot="'fee_id'" slot-scope='record' name='fee_id' :record='record'/>
    <slot :slot="'agency_code'" slot-scope='record' name='agency_code' :record='record'/>
    <slot :slot="'in_accounting'" slot-scope='record' name='in_accounting' :record='record'/>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedAgency(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
