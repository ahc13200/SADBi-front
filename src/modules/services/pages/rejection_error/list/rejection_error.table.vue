<template>
  ...
  >
    ...
    <slot :slot="'error_code'" slot-scope='record' name='error_code' :record='record'/>
    <slot :slot="'error_source'" slot-scope='record' name='error_source' :record='record'/>
    <slot :slot="'description_es'" slot-scope='record' name='description_es' :record='record'/>
    <slot :slot="'description_en'" slot-scope='record' name='description_en' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedRejection_error(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
