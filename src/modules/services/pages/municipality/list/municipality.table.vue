<template>
  ...
  >
    ...
    <slot :slot="'municipality_code'" slot-scope='record' name='municipality_code' :record='record'/>
    <slot :slot="'municipality_name'" slot-scope='record' name='municipality_name' :record='record'/>
    <slot :slot="'province_id'" slot-scope='record' name='province_id' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedMunicipality(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
