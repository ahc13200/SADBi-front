<template>
  ...
  >
    ...
    <slot :slot="'batch_id'" slot-scope='record' name='batch_id' :record='record'/>
...
export default {
  name: "sentai_batch_details_table",
  ...
  inject: {
    ...
    setSelectedSentai_batch_details: {
      default: () => {
      }
    }
  },
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedSentai_batch_details(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
