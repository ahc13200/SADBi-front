<template>
  ...
  >
    ...
    <slot :slot="'monthly_received_amount'" slot-scope='record' name='monthly_received_amount' :record='record'/>
...
export default {
  name: "beneficiary_control_amount_table",
  ...
  inject: {
    ...
    setSelectedBeneficiary_control_amount: {
      default: () => {
      }
    }
  },
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedBeneficiary_control_amount(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
