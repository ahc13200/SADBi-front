<template>
  ...
  >
    ...
    <slot :slot="'object_pk'" slot-scope='record' name='object_pk' :record='record'/>
    <slot :slot="'object_id'" slot-scope='record' name='object_id' :record='record'/>
    <slot :slot="'object_repr'" slot-scope='record' name='object_repr' :record='record'/>
    <slot :slot="'action'" slot-scope='record' name='action' :record='record'/>
    <slot :slot="'changes'" slot-scope='record' name='changes' :record='record'/>
    <slot :slot="'timestamp'" slot-scope='record' name='timestamp' :record='record'/>
    <slot :slot="'actor_id'" slot-scope='record' name='actor_id' :record='record'/>
    <slot :slot="'content_type_id'" slot-scope='record' name='content_type_id' :record='record'/>
    <slot :slot="'remote_addr'" slot-scope='record' name='remote_addr' :record='record'/>
    <slot :slot="'additional_data'" slot-scope='record' name='additional_data' :record='record'/>
    <slot :slot="'serialized_data'" slot-scope='record' name='serialized_data' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedAuditlog_logentry(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
