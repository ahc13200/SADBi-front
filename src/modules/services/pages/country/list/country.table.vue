<template>
  ...
  >
    ...
    <slot :slot="'country_code'" slot-scope='record' name='country_code' :record='record'/>
    <slot :slot="'country_name'" slot-scope='record' name='country_name' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedCountry(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
