<template>
  ...
  >
    ...
    <slot :slot="'send_date'" slot-scope='record' name='send_date' :record='record'/>
    <slot :slot="'state'" slot-scope='record' name='state' :record='record'/>
    <slot :slot="'sentai_trans_no'" slot-scope='record' name='sentai_trans_no' :record='record'/>
    <slot :slot="'agency_id'" slot-scope='record' name='agency_id' :record='record'/>
    <slot :slot="'sentai_batch_datetime'" slot-scope='record' name='sentai_batch_datetime' :record='record'/>
    <slot :slot="'sentai_home_amount'" slot-scope='record' name='sentai_home_amount' :record='record'/>
    <slot :slot="'sentai_home_fee'" slot-scope='record' name='sentai_home_fee' :record='record'/>
    <slot :slot="'sentai_trans_amount'" slot-scope='record' name='sentai_trans_amount' :record='record'/>
    <slot :slot="'sentai_trans_fee'" slot-scope='record' name='sentai_trans_fee' :record='record'/>
    <slot :slot="'sentai_error'" slot-scope='record' name='sentai_error' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedSentai_batch(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
