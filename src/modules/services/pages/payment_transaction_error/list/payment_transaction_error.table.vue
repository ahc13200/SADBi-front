<template>
  ...
  >
    ...
    <slot :slot="'error_date'" slot-scope='record' name='error_date' :record='record'/>
    <slot :slot="'field_related'" slot-scope='record' name='field_related' :record='record'/>
    <slot :slot="'error_id'" slot-scope='record' name='error_id' :record='record'/>
    <slot :slot="'transaction_id'" slot-scope='record' name='transaction_id' :record='record'/>
  </a-table>
</template>
...
export default {
  name: "payment_transaction_error_table",
  ...
  inject: {
    ...
    setSelectedPayment_transaction_error: {
      default: () => {
      }
    }
  },
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedPayment_transaction_error(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
