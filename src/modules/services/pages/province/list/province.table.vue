<template>
  ...
  >
    ...
    <slot :slot="'province_code'" slot-scope='record' name='province_code' :record='record'/>
    <slot :slot="'province_name'" slot-scope='record' name='province_name' :record='record'/>
    <slot :slot="'country_id'" slot-scope='record' name='country_id' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedProvince(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
