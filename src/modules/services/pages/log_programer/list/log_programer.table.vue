<template>
  ...
  >
    ...
    <slot :slot="'log_description'" slot-scope='record' name='log_description' :record='record'/>
    <slot :slot="'trace'" slot-scope='record' name='trace' :record='record'/>
    <slot :slot="'created_at'" slot-scope='record' name='created_at' :record='record'/>
    <slot :slot="'system'" slot-scope='record' name='system' :record='record'/>
  </a-table>
</template>
...
export default {
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedLog_programer(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
