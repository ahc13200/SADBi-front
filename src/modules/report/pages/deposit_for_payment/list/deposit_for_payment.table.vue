<template>
  ...
  >
    ...
    <slot :slot="'total_transaction'" slot-scope='record' name='total_transaction' :record='record'/>
    <slot :slot="'total_amount'" slot-scope='record' name='total_amount' :record='record'/>
    <slot :slot="'total_fee'" slot-scope='record' name='total_fee' :record='record'/>
    <slot :slot="'min'" slot-scope='record' name='min' :record='record'/>
    <slot :slot="'max_date'" slot-scope='record' name='max_date' :record='record'/>
  </a-table>
</template>
...
export default {
  name: "deposit_for_payment_table",
  ...
  inject: {
    ...
    setSelectedDeposit_for_payment: {
      default: () => {
      }
    }
  },
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedDeposit_for_payment(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
