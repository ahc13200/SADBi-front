<template>
  ...
  >
    ...
    <slot :slot="'count'" slot-scope='record' name='count' :record='record'/>
...
export default {
  name: "consiliation_bank_view_table",
  ...
  inject: {
    ...
    setSelectedConsiliation_bank_view: {
      default: () => {
      }
    }
  },
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedConsiliation_bank_view(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
