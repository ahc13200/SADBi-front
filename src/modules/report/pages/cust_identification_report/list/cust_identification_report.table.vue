<template>
  ...
  >
    ...
    <slot :slot="'agency_name'" slot-scope='record' name='agency_name' :record='record'/>
    <slot :slot="'agency_code'" slot-scope='record' name='agency_code' :record='record'/>
    <slot :slot="'sentai_code'" slot-scope='record' name='sentai_code' :record='record'/>
    <slot :slot="'issuing_bank'" slot-scope='record' name='issuing_bank' :record='record'/>
    <slot :slot="'bank_code'" slot-scope='record' name='bank_code' :record='record'/>
    <slot :slot="'bank_name'" slot-scope='record' name='bank_name' :record='record'/>
    <slot :slot="'currency_code'" slot-scope='record' name='currency_code' :record='record'/>
    <slot :slot="'cust_municipality_name'" slot-scope='record' name='cust_municipality_name' :record='record'/>
    <slot :slot="'cust_province_name'" slot-scope='record' name='cust_province_name' :record='record'/>
    <slot :slot="'sender_country_name'" slot-scope='record' name='sender_country_name' :record='record'/>
    <slot :slot="'state_code'" slot-scope='record' name='state_code' :record='record'/>
    <slot :slot="'description_es'" slot-scope='record' name='description_es' :record='record'/>
  </a-table>
</template>
...
export default {
  name: "cust_identification_report_table",
  ...
  inject: {
    ...
    setSelectedCust_identification_report: {
      default: () => {
      }
    }
  },
  ...
  methods: {
    ...
    onEditing(model) {
      ...
      this.setSelectedCust_identification_report(this.selected_model)
      this.show_form();
    }
  },
  mounted() {
